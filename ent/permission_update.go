...
func (pu *PermissionUpdate) AddRoleIDs(ids ...uint32) *PermissionUpdate {
...
func (pu *PermissionUpdate) RemoveRoleIDs(ids ...uint32) *PermissionUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (puo *PermissionUpdateOne) AddRoleIDs(ids ...uint32) *PermissionUpdateOne {
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (puo *PermissionUpdateOne) RemoveRoleIDs(ids ...uint32) *PermissionUpdateOne {
