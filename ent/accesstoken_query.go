...
func (atq *AccessTokenQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (atq *AccessTokenQuery) FirstIDX(ctx context.Context) uint64 {
...
func (atq *AccessTokenQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (atq *AccessTokenQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (atq *AccessTokenQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (atq *AccessTokenQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := atq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (atq *AccessTokenQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*AccessToken, init func(*AccessToken), assign func(*AccessToken, *User)) error {
	...
	nodeids := make(map[uint64][]*AccessToken)
	for i := range nodes {
...
func (atq *AccessTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accesstoken.Table, accesstoken.Columns, sqlgraph.NewFieldSpec(accesstoken.FieldID, field.TypeUint64))
	_spec.From = atq.sql
