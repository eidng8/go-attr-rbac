...
func (atu *AccessTokenUpdate) SetOwnerID(id uint64) *AccessTokenUpdate {
	atu.mutation.SetOwnerID(id)
	return atu
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (atu *AccessTokenUpdate) SetNillableOwnerID(id *uint64) *AccessTokenUpdate {
	if id != nil {
		atu = atu.SetOwnerID(*id)
	}
	return atu
}
...
func (atu *AccessTokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(accesstoken.Table, accesstoken.Columns, sqlgraph.NewFieldSpec(accesstoken.FieldID, field.TypeUint64))
...
// SetOwnerID sets the "owner" edge to the User entity by ID.
func (atuo *AccessTokenUpdateOne) SetOwnerID(id uint64) *AccessTokenUpdateOne {
	atuo.mutation.SetOwnerID(id)
	return atuo
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (atuo *AccessTokenUpdateOne) SetNillableOwnerID(id *uint64) *AccessTokenUpdateOne {
	if id != nil {
		atuo = atuo.SetOwnerID(*id)
	}
	return atuo
}
