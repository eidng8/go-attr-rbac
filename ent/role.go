...
// PluckRoleID returns the "ID" field value.
func PluckRoleID(r *Role) uint32 {
	return r.ID
}

// PluckRoleName returns the "name" field value.
func PluckRoleName(r *Role) string {
	return r.Name
}

// PluckRoleDescription returns the "description" field value.
func PluckRoleDescription(r *Role) string {
	return r.Description
}

// PluckRoleCreatedAt returns the "created_at" field value.
func PluckRoleCreatedAt(r *Role) *time.Time {
	return r.CreatedAt
}

// PluckRoleUpdatedAt returns the "updated_at" field value.
func PluckRoleUpdatedAt(r *Role) *time.Time {
	return r.UpdatedAt
}
