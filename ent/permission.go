...
// PluckPermissionID returns the "ID" field value.
func PluckPermissionID(pe *Permission) uint32 {
	return pe.ID
}

// PluckPermissionName returns the "name" field value.
func PluckPermissionName(pe *Permission) string {
	return pe.Name
}

// PluckPermissionDescription returns the "description" field value.
func PluckPermissionDescription(pe *Permission) string {
	return pe.Description
}

// PluckPermissionCreatedAt returns the "created_at" field value.
func PluckPermissionCreatedAt(pe *Permission) *time.Time {
	return pe.CreatedAt
}

// PluckPermissionUpdatedAt returns the "updated_at" field value.
func PluckPermissionUpdatedAt(pe *Permission) *time.Time {
	return pe.UpdatedAt
}
